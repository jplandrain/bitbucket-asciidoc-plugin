...
Manual installation into your Bitbucket server must be achieved. The release files can be found on this GitHub: https://github.com/jplandrain/bitbucket-asciidoc-plugin/releases
